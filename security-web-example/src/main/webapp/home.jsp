...
<body>
	...
	<p><form name="loginform" action="query" method="post">
...
<p>
    ...
    <table class="sample">
        <tr>
            <td> 	<form name="Reloadform" action="query" method="post">
<input type="hidden" name="reload" value="true" />
<input type="submit" name="submit" value="Reload Model" />
</form></td>
        </tr>
        <tr>
            <td><form name="listUsersform" action="query" method="post">
...
<input type="submit" name="submit" value="List Users" />
        ...
        <tr>
            <td><form name="listMambersform" action="query" method="post">
...
<input type="submit" name="submit" value="List Members" />
                ...
                <tr>
            <td><form name="listAppsform" action="query" method="post">
...
<p><form name="UserMemform" action="query" method="post">
...
<p><form name="UserAppform" action="query" method="post">
...
<p><form name="UserAppPermform" action="query" method="post">
...
<p><form name="AppPermGroupform" action="query" method="post">
...
<p><form name="AppUsersform" action="query" method="post">
