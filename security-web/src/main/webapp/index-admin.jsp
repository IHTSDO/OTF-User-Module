...
<body>
	<script src="<%= request.getContextPath()%>/jquery-2.1.0.js"
	...
	<div id="pageWrap" class="contain">
		<header>
			<nav class="top contain" style="vertical-align: middle">
				<ul class="contain" style="vertical-align: middle">
					...
					<li style="vertical-align: middle"><a href="/contact-us/">Contact
							Us</a></li>
				</ul>
			</nav>
			<h1 class="logo">
				<a href="/">ihtsdo Leading healthcare terminology, worldwide</a>
			</h1>
			<nav class="main contain"></nav>
		</header>
		<section class="mainContent contain">
			...
			<div class="container">
				<div class="row">
					...
					<div class="topRow">
						<a href="<%=context%>apps">Apps</a>
					</div>
					<div class="topRow">
						<a href="<%=context%>members">Members</a>
					</div>
					<div class="topRow">
						<a href="<%=context%>settings">Settings</a>
					</div>
					<div class="topRow">
						<a href="<%=context%>reload">Reload</a>
					</div>
					<%if(canSave){%>
					<div class="topRow">
						<a href="<%=context%>save">Save</a>
					</div>
					<%}%>
		...
		<footer class="contain">
			<p class="companyName">
				<span>International Health Terminology Standards Development
					Organisation</span>
			</p>
			<ul class="social contain">
				<li class="text">Follow us:</li>
				<li class="linkedIn"><a
					href="https://www.linkedin.com/company/ihtsdo" target="_blank">LinkedIn</a>
				</li>
				<li class="twitter"><a href="https://twitter.com/SnomedCT"
					target="_blank">twitter</a></li>
				<li class="googlePlus"><a href="http://google.com/+IhtsdoOrg"
					target="_blank">google+</a></li>
			</ul>
			<ul class="footerLinks contain">
				<li><a href="http://www.ihtsdo.org/news-articles">News</a></li>
				<li><a href="https://ihtsdo.freshdesk.com/support/home">FAQ</a>
				</li>
				<li><a href="http://www.ihtsdo.org/members/">Members</a></li>
				<li><a href="http://www.ihtsdo.org/contact-us/">Contact Us</a>
				</li>
				<li><span>&copy; Copyright IHTSDO 2014</span></li>
			</ul>
		</footer>
	</div>
