...
(function ($) {
    ...
    function onError(error, inputElement) {  // 'this' is the form element
        var validators = $(this).find("[data-valmsg-for='" + escapeAttributeValue(inputElement[0].name) + "']");
        error.data("unobtrusiveContainer", validators);

        for (var index = 0; index < validators.length; index++) {
            var container = $(validators[index]);
    ...
    function onSuccess(error) {  // 'this' is the form element
        var validators = error.data("unobtrusiveContainer");
